...
const Hero:React.FC = () => (
    <section id='hero' className='grid md:grid-cols-2 gap-20 items-center p-16 mt-4'>
        <div className='flex flex-col gap-8'>
            <h1 className='text-5xl bg-gradient-to-r from-purple-300 to-indigo-300 rounded-md font-bold bg-clip-text text-transparent leading-[1.1]'>
            ...
            <div className='flex flex-row gap-4'>
                <a href="" className='text-white bg-gradient-to-r from-purple-600 to-indigo-600 px-4 py-2 hover:scale-105 rounded-md font-semibold'>View Projects</a>
        ...
        <div className='w-[450px] h-72 lg:ml-20 rounded-lg border border-purple-900 shadow-2xl shadow-purple-500'>
